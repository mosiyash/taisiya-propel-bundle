...
abstract class Index implements IndexInterface
{
     ...
     * @return Index
     */
    final public function addColumn(Column $column, int $size = null): self
    {
     ...
     * @return Index
     */
    final public function addColumnIfNotExists(Column $column, int $size = null): self
    {
        if (!$this->hasColumn($column::getName())) {
     ...
     * @return Index
     */
    final public function removeColumn(string $name): self
    {
